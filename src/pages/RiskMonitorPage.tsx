  ...
  return (
    <div className="p-6 animate-fade-in">
      <div className="flex items-center justify-between mb-6 flex-wrap gap-4">
        <div>
          <h1 className="text-2xl font-bold" style={{ fontFamily: "Outfit, sans-serif", color: "#e8f1f8" }}>Risk Monitor</h1>
          <p className="text-sm mt-1" style={{ color: "#5a7d96" }}>Real-time market, port, demand, and forecast-uncertainty risk scoring</p>
        </div>
      ...
      <RiskMonitorModule port={port} cargo={cargo} />
    </div>
  );
}
